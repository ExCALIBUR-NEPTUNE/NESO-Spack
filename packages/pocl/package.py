...
class Pocl(CMakePackage):
    ...
    depends_on("llvm @16:17", when="@master")
    ...
    variant("shared_llvm", default=False, description="Dynamically link against llvm")
    ...
    def cmake_args(self):
        args = [
            ...
            self.define("STATIC_LLVM", False if "+shared_llvm" in self.spec else True),
