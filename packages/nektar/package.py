...
class Nektar(CMakePackage):
    ...
    variant("imgwarp_solver", default=False, description="Builds a library and an executable associated with the Image Warping solver")
    variant("ins_solver", default=False, description="Builds a library and an executable associated with the Incompressible Navier Stokes solver")
    variant("mmf_solver", default=False, description="Builds a library and an executable associated with the MMF solver")
    variant("pulsewave_solver", default=False, description="Builds a library and an executable associated with the Pulse Wave solver")
    variant("shwater_solver", default=False, description="Builds a library and an executable associated with the Shallow Water solver")
    variant("vortexwave_solver", default=False, description="Builds a library and an executable associated with the Vortex Wave solver")
